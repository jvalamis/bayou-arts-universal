...
/// Universal AppTheme for Eddie applications
/// Provides consistent theming across all generated apps
class AppTheme {
  static const Color defaultSeed = Color(0xFF5F6FFF);
  
  /// Create light theme from brand seed color
  ...
  /// Create dark theme from brand seed color
  ...
  /// Parse brand seed color from hex string
  static Color parseBrandSeed(String? hexColor) {
